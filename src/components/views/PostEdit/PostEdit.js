                ...
                {value.status
                  ...
                  <Paper className={styles.paperCard}>
                    <form onSubmit={this.submitForm}>
                      ...
                      <Grid item xs={12} sm={9} className={styles.paperCard__item}>
                        <TextField required value={postById.email} name="email" label="Email address" fullWidth onChange={this.handleChange} />
                      </Grid>
                      <Grid item xs={12} sm={9} className={styles.paperCard__item}>
                        <TextField value={postById.phone} name="phone" label="Phone number" fullWidth type="number" onChange={this.handleChange}/>
                      </Grid>
                      <Grid item xs={12} sm={9} className={styles.paperCard__item}>
                        <TextField value={postById.location} name="location" label="Localization" fullWidth onChange={this.handleChange}/>
                      </Grid>
                      <Grid item xs={12} sm={9} className={styles.paperCard__item}>
...
const mapStateToProps = (state, props) => ({
  postById: getOne(state, props.match.params.id),
});
